...
- **kitchen** → `KitchenScreen` (μόνο δελτία φαγητών, χωρίς navigation)
...
- **Ειδοποιήσεις runner με σύγκριση IDs**, όχι πλήθους — ίδιο πλήθος μπορεί να
  κρύβει ένα νέο + ένα σερβιρισμένο στο ίδιο snapshot.
